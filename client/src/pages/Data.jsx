 ...
 function Data() {
  ...
  return (
    <main className='main min-h-screen w-full absolute z-0 top-0  '>
      ...
      <div className="table pt-20  mx-auto mb-4 ">
        <table >
          <thead >
          <tr  className='w-full flex text-black gap-x-[6vw] mobile:gap-x-36 font-semibold mobile:text-lg text-sm bg-gray-300  border-white border-[1px] p-2 rounded-md'>
          <th>Date</th>
          <th>Product</th>
          <th>Expense</th>
          <th>Income</th>
          ...
          {createdUser.map((data)=>{
            return    <tr key={data._id} className='w-full flex bg-white rounded-md text-[10px] mobile:text-lg p-2 font-bold text-black border-gray-500 border-[1px]'>
